...
export const LeftEmpty = () => {
  return (
    <svg viewBox="0 0 1024 1024" style={{ width: '240px', height: '240px' }}>
      <rect
      ...
      <rect
        ...
        style={{
          ...
          animation:
            '3.3s linear infinite both helper-drag-rec_w, 3.3s linear infinite both helper-drag-rec_h, 3.3s linear infinite both helper-drag-rec_mo',
          offsetPath:
            "path('M206.034,298.157L205.034,298.157C481.262,280.399,662.717,480.353,670.01,510.157L505.01,280.552L515.01,290.157L515.01,290.157')",
          offsetRotate: '0deg',
        }}
      ></rect>
      <g
        ...
        style={{
          ...
          offsetPath:
            " path('M200,613L200,290L200,300L200,300C371.375,309.667,501.439,327.173,663.976,512L663.976,512')",
          offsetRotate: '0deg',
        }}
      >
        <path
      ...
      <g
        ...
        style={{
          animation: '3.3s linear infinite both helper-drag-boomrightup_o',
        }}
      >
        <path
          fill="#b6b6b6"
      ...
      <g
        ...
        style={{
          animation: '3.3s linear infinite both helper-drag-boomleftup_o',
        }}
      >
        <path
          fill="#b6b6b6"
      ...
      <g
        ...
        style={{
          animation: '3.3s linear infinite both helper-drag-boomrightbottom_o',
        }}
      >
        <path
          fill="#b6b6b6"
      ...
      <g
        ...
        style={{
          animation: '3.3s linear infinite both helper-drag-boomleftbottom_o',
        }}
      >
        <path
          fill="#b6b6b6"
